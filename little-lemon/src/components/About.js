...
function About(){
    return(
        <section id="about">
            ...
            <div class="images">
            <img class="bottom-img" src={interiorPhoto} alt='Relaxed patio seeting with large white umbrells over two person tables with padded leather armchairs'/>
            <img class="top-img" src={chefPhoto} alt='A chef sprinkling toppings on a tall salad'/>
            </div>
        </section>
    )
}
